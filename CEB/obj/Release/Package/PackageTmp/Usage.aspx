            ...
            <%
                ...
                else
                {
                    for (int i = 1; i <= n; i++)
                    {
                        ...
                        Response.Write("<h3>Account No : " + acc[i - 1] + "</h3><hr>");
            %>
            <div class='row'>
                <%-- this month usage --%>
                <div class='col-md-4'>
                    ...
                    <% Response.Write("<p style='text-align: center' id='realtime_usage_" + i + "' class='fa-4x'>" + usage[i - 1] + " (kWh) </p>"); %>
                    <p class='fa-4x'></p>
                    <br />
                    <ul style='color: red'>
                        <li>Note : </li>
