            ...
            <div class="container">
                ...
                <div class="row show-login-form.active">
                    <div class="col-sm-4 col-md-offset-4" style="border-radius: 5px; background-color: rgba(0,0,0,0.2); padding: 20px;">
                        <span style="font-family: 'Times New Roman'; font-size: 20px;"><asp:Image ID="Image1" runat="server" ImageUrl="~/res_login/ico/Title_icon.png" Height="50px" /> Recover Password</span>                        
                        <div class="l-form">
