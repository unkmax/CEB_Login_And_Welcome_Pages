...
<body>
    ...
    <form role="form" runat="server">
        ...
        <div class="row" style="padding-top: 10%">
            <div class="col-sm-10 offset-1" style="background-color: rgba(128, 128, 128,0.2)">
                <div class="row">
                ...
                <div class="row" align="center">
                    <div class="col-sm-12" style="z-index: 3">
                        <asp:Button ID="LoginBtn" runat="server" Text="Login" CssClass="myButton" OnClick="LoginBtn_Click" Style="margin: 20px;" />
                        <%--Login button--%>
                        <asp:Button ID="RegisterBtn" runat="server" Text="Register" CssClass="myButton" OnClick="RegisterBtn_Click" Style="margin: 20px;" />
                        <%--Register button--%>
                    </div>
                </div>
                ...
                <div class="row" style="margin: 10px;">
                    <div class="col-sm-6" align="center" style=" z-index: 3; padding: 20px">
                        <div style="margin-top: 15%; text-shadow: 0px 0px 3px #2f6627;">
                            <h4>Get the CEB Self Care Mobile App On Here</h4>
                            <%--App download title--%>
                            <br />
                            <asp:Button ID="AppBtn" runat="server" Text="Download App" CssClass="myButton" />
                            <%--App download button--%>
                        </div>

                    </div>
                    <div class="col-sm-6" align="center" style=" padding: 20px">
                        <asp:Image ID="Image6" runat="server" ImageUrl="~/res/images/welcome/Android.png" Width="100%" />
                        <%--Icon of the App download--%>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" align="center" style="z-index: 5">
                        <object type="image/svg+xml" data="../res/Map.min.svg" style="width: 50%; z-index: 3">
                        </object>
                    </div>
                </div>
            </div>
